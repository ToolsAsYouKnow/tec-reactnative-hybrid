...
                }}
				...
				<NavButton onPress={() => {this.props.navigator.pop();
				           ...
				           text="页面弹出(回退一页)"
				/>
				<NavButton onPress={() => {this.props.navigator.popToTop();}}
				           text="页面弹出(回退到最后一页)"
				/>
			</View>
		);
	...
	render() {
		return (
			<Navigator
				...
				renderScene={ (route, navigator) => <NavMenu message={route.message} navigator={navigator}/>}
